    ...
    def validate_on_update
      ...
      # else
        ...
        if manager = User.authenticate(self.manager_sign_username, self.manager_sign_password, Thread.current['user'].domain)
          ...
          errors.add(:store_manager, "could not be validated. Please check your username and password and try again.") if !self.manager_sign_username.blank? && !self.manager_sign_password.blank?
        end
      # end
