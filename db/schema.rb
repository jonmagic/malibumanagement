...
ActiveRecord::Schema.define(:version => 42) do
  ...
  create_table "goto_transactions", :force => true do |t|
    ...
    t.column "no_eft",                  :boolean, :default => false
    t.column "goto_invalid",            :string,  :default => "--- []\n\n"
    t.column "transaction_id",          :integer
    t.column "note_id",                 :integer
    t.column "order_number",            :string
    t.column "sent_date",               :string
    t.column "transacted_at",           :string
    t.column "status",                  :string
    t.column "description",             :string
    t.column "previous_balance",        :float
    t.column "previous_payment_amount", :float
    t.column "recd_date_due",           :boolean, :default => false
  ...
  create_table "stores", :force => true do |t|
    ...
    t.column "gcal_url",       :string
    t.column "ar_site",        :string
  end
  ...
  create_table "wildcard_forms", :force => true do |t|
    t.column "description", :text
  end
